...
def main():
    ...
    radioButtonGreen = tk.Radiobutton(master=radioButtonFrame, text='not add color', variable=radio, value=4, bg=bgColor)
    radioButtonGreen.grid(row=3, column=0, sticky=tk.W)
